module.exports = {
  ...
  things:  [
    { topic: 'smartthings/Back Office Multisensor', type: '4-in-1', name: 'Back Office Multisensor'  },
    { topic: 'smartthings/Back Room Switch', type: 'switch', name: 'Back Room Switch',  },
    { topic: 'smartthings/Back Room Fan', type: 'fan', name: 'Back Room Fan',  },
    { topic: 'smartthings/Outdoor Lights', type: 'fan', name: 'Outdoor Lights',  },
